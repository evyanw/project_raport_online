                ...
                //     $id_siswa=trim($_GET['id_siswa']);
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>                        
                        <a href="../guru/nilai_bindo.php?id_siswa=<?php echo $d['id_siswa'] ?>"><button>INPUT NILAI</button></a> 
                      </td>
                      <td>                        
                        <a href="data_nilai.php?id_siswa=<?php echo $d['id_siswa'] ?>"><button>HASIL NILAI</button></a> 
                      </td>
                    </tr>

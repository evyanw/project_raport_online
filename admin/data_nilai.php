<html>
    ...
    <div class="float-left">
			<a href="data_siswa.php" target="_blank" class="btn btn-danger"><i class="fa fa-arrow-circle-left" ></i> &nbsp KEMBALI</a>
			<br>
			<br>
	</div>
        <div class="container">
...
&nbsp;
    ...
    ?>
        <div class="float-right">
			<a href="../transaksi/nilai_raport_pdf.php?id_siswa=<?php echo $id_siswa ?>" target="_blank" class="btn btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp PRINT</a>
			<br>
			<br>
		</div>
...
<table border="1" cellpadding="2">
        ...
        <tr>
            <td>.....................</td>
            <td>Rr. Retna Trimantraningsih, S.T</td>
        </tr>
        <tr>
            <td>NIP 19700627 202121 2 002</td>
        </tr>
</table>
